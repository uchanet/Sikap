        ...
        <div class="hpanel">
            <div class="panel-body">
                ...
                <h2 class="font-light m-b-xs">
                    <a href="<?= base_url('form/add'); ?>" class="btn btn-primary" type="button"><i class="pe-7s-note2"></i> <br />Add Form</a> <?= $title; ?>
                </h2>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="hpanel">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-md-10 forum-heading">
                                    ...
                                    <span class="label label-success pull-left">Newest</span>
                    ...
                    <!-- <div class="panel-body">
                        <input type="text" class="Respons-control input-sm m-b-md" id="filter" placeholder="Search in table">
