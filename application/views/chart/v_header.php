		...
		<ul class="nav" id="side-menu">
			...
			<li>
				...
				<ul class="nav nav-second-level">
					...
					<li>
						<a href="<?= base_url('analytic') ?>"><i class="fas fa-map"></i>Analytic</a>
					</li>
					<li>
						<a href="<?= base_url('graphic') ?>"><i class="fas fa-map"></i>Graphic</a>
					</li>
				</ul>
			</li>
			...
			<li>
				<a href="<?= base_url('rumah') ?>">
					<span class="nav-label">Data Spatial</span><span class="label label-warning pull-right">NEW</span>
				</a>
			</li>

			<li>
				<a href="<?= base_url('sosial') ?>">
					<span class="nav-label">Data Social</span><span class="label label-warning pull-right">NEW</span>
				</a>
			</li>
			...
			<li>
				<a href="<?= base_url('sectoral') ?>">
					...
					<span class="nav-label">Data Sectoral</span><span class="label label-warning pull-right">NEW</span>
				</a>
			</li>

			<li>
				<a href="#"><span class="nav-label">Settings</span><span class="fa arrow"></span>
				</a>
				<ul class="nav nav-second-level">
					...
					<li>
						<a href="<?= base_url('rumah') ?>"><i class="fas fa-location-arrow"></i>List Data Spatial</a>
					</li>
